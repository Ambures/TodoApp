...
//PUT request 
    app.put("/todos/:id", async (req, res) => {
        try{
         ...
         res.status(200).send(200).send("updated entry " + id + " with new text: " + newText);
         } catch (err) {
            console.log(err);
...
// connect to database
const connectionString = "mongodb+srv://amburesmcgil:intake25A@cluster0.xj3svde.mongodb.net/todoDB";
